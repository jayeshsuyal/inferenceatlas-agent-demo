...
JUDGE_COMMANDS = [
    ...
    "python3 -m agent.spend examples/requests/ai_spend_budget_overrun.yml",
...
def build_judge_report(*, write_artifacts: bool = True) -> dict[str, Any]:
    ...
    return {
        ...
        "ai_spend_review": {
            ...
            "request_path": spend_review["request_path"],
...
def render_judge_report_markdown(report: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            f"- request: `{report['ai_spend_review']['request_path']}`",
