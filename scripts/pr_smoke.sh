...
json_check schemas/coach_suggestion.schema.json /tmp/ia_coach_suggestion_schema.checked.json
...
command_json_check /tmp/ia_proof_graph.all_sponsors.json "$PYTHON_BIN" -m agent.proof_graph --include-all-sponsors --json
