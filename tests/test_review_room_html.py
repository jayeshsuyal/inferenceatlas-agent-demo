...
class ReviewRoomHtmlTests(unittest.TestCase):
    def test_rendered_html_contains_review_room_sections(self) -> None:
        ...
        self.assertIn("Sponsor Proof Pack", html)
        self.assertIn("Sponsor tools enrich proof packets", html)
        self.assertIn("permission_diff", html)
        self.assertIn("locked_field_narration", html)
