...
class SkillsRegistryTests(unittest.TestCase):
    ...
    def test_skills_report_is_agent_readable(self) -> None:
        ...
        self.assertEqual(report["summary"]["registered_skills"], 15)
        self.assertEqual(report["summary"]["stable_skills"], 15)
        self.assertEqual(report["summary"]["available_stable_skills"], 15)
    ...
    def test_skills_cli_outputs_human_and_json_views(self) -> None:
        ...
        self.assertIn("15 / 15 stable skills available", text_result.stdout)
        ...
        self.assertEqual(payload["summary"]["available_stable_skills"], 15)
