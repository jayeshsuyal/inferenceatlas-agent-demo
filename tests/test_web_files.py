...
class WebFilesTests(unittest.TestCase):
    ...
    def test_chat_empty_state_surfaces_locked_proof_state(self) -> None:
        ...
        self.assertIn("Review coach", html)
        ...
        self.assertIn("Collapse Ask IA coach", html)
        ...
        self.assertIn('class="repo-infra-rows"', html)
        ...
        self.assertIn('class="repo-ask-sidecar"', html)
        self.assertIn('id="repo-coach-form"', html)
        self.assertIn('aria-label="Contextual Ask IA suggestions"', html)
        self.assertIn('aria-label="Contextual packet coach suggestions"', html)
        ...
        self.assertIn('/static/app.js?v=73', html)
        ...
        self.assertIn("Owner: ${escapeHtml(ownerGroup)}", js)
        ...
        self.assertNotIn("data-ask-prompt=", html)
        self.assertIn("normalizeCoachSuggestion", js)
        self.assertIn("renderCoachChips", js)
        self.assertIn("refreshRunwayCoachChips", js)
        self.assertIn("autoReassessReviewRunCoach", js)
        self.assertIn("handleCoachChipPick", js)
        self.assertIn("chip_entities", js)
        self.assertIn("repoCoachForm", js)
        self.assertIn("setCoachForPacket", js)
        ...
        self.assertIn(".coach-section-card", css)
        self.assertIn("consumeCoachStream", js)
        self.assertIn("initCoachPanelResize", js)
        self.assertIn('id="repo-coach-resize-handle"', html)
    ...
    def test_chat_api_greeting_uses_intake_not_packet_dump(self) -> None:
        ...
        self.assertIn("Can fixture mcp_tool_blast_radius move", response.reply)
        self.assertIn("suggestions", response.answer)
        self.assertIn("What proof is missing for fixture", response.reply)
