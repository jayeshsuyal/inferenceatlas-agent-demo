...
class WebFilesTests(unittest.TestCase):
    ...
    def test_chat_empty_state_surfaces_locked_proof_state(self) -> None:
        ...
        self.assertIn(
            "Select prepared human proof receipts. This does not approve access; it only marks evidence for a packet rerun.",
            html,
        )
        ...
        self.assertIn("You selected ${name}. Should I generate the repo-access packet next?", js)
