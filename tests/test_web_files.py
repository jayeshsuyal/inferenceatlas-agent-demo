...
class WebFilesTests(unittest.TestCase):
    ...
    def test_chat_empty_state_surfaces_locked_proof_state(self) -> None:
        ...
        self.assertIn("I am watching this ReviewRun. Choose one repo and I will keep the next human action, blocked scope, and Portkey impact in sync.", html)
        ...
        self.assertIn('id="repo-coach-chat"', html)
        self.assertIn('id="repo-coach-last-user"', html)
        self.assertIn('id="repo-coach-last-user-text"', html)
        ...
        self.assertIn('/static/app.js?v=76', html)
        ...
        self.assertIn('includeCurrentRead ? ["Current read", sections.current_read] : null', js)
        self.assertIn("repoCoachInput?.blur();", js)
        ...
        self.assertIn("payload.entities = entities", js)
        self.assertIn("suggestion?.entities || null", js)
        ...
        self.assertIn('id="repo-coach-answer"', html)
        ...
        self.assertIn(".repo-coach-chat", css)
        self.assertIn(".repo-coach-last-user", css)
        self.assertIn('.repo-ask-sidecar[data-user-turn="true"] .repo-coach-current-read', css)
        self.assertIn('.repo-ask-sidecar[data-user-turn="true"] .repo-coach-chat', css)
