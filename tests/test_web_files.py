...
class WebFilesTests(unittest.TestCase):
    ...
    def test_chat_empty_state_surfaces_locked_proof_state(self) -> None:
        ...
        self.assertIn("Ask IA what happens next...", html)
        ...
        self.assertIn("You selected ${name}. Next: click Review access to generate the IA Packet.", js)
        ...
        self.assertIn("Your packet is generated for ${selectedReviewRepoName()}. Verdict:", js)
        self.assertIn("proofOwnerSummaryForPacket", js)
        self.assertIn("Missing proof owners: ${proofOwnerText}.", js)
        self.assertIn("To resolve blocked claims, attach proof from ${proofOwnerText}, then regenerate the packet. Ask IA cannot approve them from chat.", js)
        ...
        self.assertIn("repo-proofgraph-map", js)
