...
class WebFilesTests(unittest.TestCase):
    ...
    def test_chat_empty_state_surfaces_locked_proof_state(self) -> None:
        ...
        self.assertIn("function reviewRunFreshStartRequested()", js)
        self.assertIn('params.get("fresh")', js)
        self.assertIn('params.get("reset_review")', js)
        self.assertIn("clearReviewRunFreshStartParam();", js)
        self.assertIn("restartReviewRunInSession();", js)
        ...
        self.assertIn("Minimize chat coach to header", html)
        self.assertIn('id="repo-coach-stage"', html)
        self.assertIn('id="review-flow-steps"', html)
        self.assertIn('id="review-session-hub"', html)
        self.assertIn('id="review-session-hub-accordion"', html)
        self.assertIn('id="btn-new-review-run"', html)
        ...
        self.assertIn('id="repo-index-detail-modal"', html)
        self.assertIn('id="btn-show-index-summary"', html)
        ...
        self.assertIn('id="repo-proofgraph-export-link"', html)
        self.assertIn('href="/proofgraph.svg?fixture=support_triage_agent"', html)
        ...
        self.assertIn('class="repo-approval-receipt"', html)
        self.assertIn('aria-label="Portable approval receipt"', html)
        ...
        self.assertIn('/static/portkey_connect_shared.js?v=1', html)
        self.assertIn('/static/app.js?v=90', html)
        ...
        self.assertIn("Export SVG", js)
        self.assertIn("currentReviewRunProofGraph", js)
        self.assertIn("reviewRunProofGraphUrl", js)
        self.assertIn("reviewRunProofGraphExportUrl", js)
        self.assertIn("syncProofGraphStaticLinks", js)
        self.assertIn("packetRef.run_id || parseReviewRunFromUrl().runId", js)
        ...
        self.assertIn("/proofgraph.svg?review_run_id=", js)
        ...
        self.assertIn("currentReviewRunPortkeyReceipt", js)
        self.assertIn("fetchReviewRunPortkeyReceipt", js)
        ...
        self.assertIn("Open verification", js)
        self.assertIn("Copy PR snippet", js)
        self.assertIn("formatApprovalReceiptPrSnippet", js)
        self.assertIn("Humans approve scoped movement. IA records and packages", js)
        self.assertIn("IA did not approve, write, grant, or mutate Portkey policy", js)
        self.assertIn('/portkey/live-proof', js)
        self.assertIn("review_run_portkey_live_proof.v0", js)
        self.assertIn("formatPortkeyLiveMetadata", js)
        self.assertIn("Copy Portkey metadata", js)
        self.assertIn("Refresh live proof", js)
        self.assertIn("data-portkey-metadata", js)
        self.assertIn("Setup metadata", js)
        self.assertIn("Clipboard unavailable. Setup metadata is expanded below.", js)
        ...
        self.assertIn("Portkey call receipt", js)
        self.assertIn("Live BYO webhook", js)
        self.assertIn("Rehearsal webhook", js)
        self.assertIn("Portkey enforcement outcome", js)
        self.assertIn("Live Portkey dashboard proof", js)
        ...
        self.assertIn("restartReviewRunInSession", js)
        self.assertIn("branchReviewRunAtScreen", js)
        self.assertIn("refreshReviewRunRail", js)
        self.assertIn("openReviewRunInChat", js)
        self.assertIn("renderReviewRunHubAccordion", js)
        self.assertIn("setReviewSessionHubExpanded", js)
        self.assertIn("openRepoIndexDetailModal", js)
        self.assertIn("fetchReviewRunRepoPaths", js)
        self.assertIn("/index-report", js)
        ...
        self.assertIn(".repo-portkey-live-receipt", css)
        self.assertIn(".repo-portkey-receipt-grid", css)
        self.assertIn(".repo-portkey-metadata", css)
        ...
        self.assertIn(".review-session-hub", css)
        self.assertIn(".review-session-hub-panel[hidden]", css)
        self.assertIn(".review-session-hub-accordion", css)
        self.assertIn(".repo-index-detail-modal", css)
        self.assertIn(".repo-index-bar-chart", css)
        self.assertIn(".review-flow-readonly-banner", css)
    ...
    def test_design_partner_walkthrough_ui_is_reachable(self) -> None:
        ...
        self.assertIn('href="${reviewRunProofGraphExportUrl()}" download>Export SVG</a>', js)
