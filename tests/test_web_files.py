...
class WebFilesTests(unittest.TestCase):
    ...
    def test_chat_empty_state_surfaces_locked_proof_state(self) -> None:
        ...
        self.assertIn('/static/style.css?v=61', html)
        self.assertIn('/static/app.js?v=91', html)
        ...
        self.assertIn("resetRepoIndex", js)
        self.assertIn("/rewind", js)
        self.assertIn('id="btn-reset-repo-index"', html)
        self.assertIn('id="portkey-connect-meta"', html)
        self.assertIn('data-stage-screen="portkey_build"', html)
        self.assertIn("implementPortkeyPacketBuild", js)
        self.assertIn("/portkey/build-plan", js)
        self.assertIn("/portkey/implement", js)
