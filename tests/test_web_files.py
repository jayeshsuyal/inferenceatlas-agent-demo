...
class WebFilesTests(unittest.TestCase):
    ...
    def test_chat_empty_state_surfaces_locked_proof_state(self) -> None:
        ...
        self.assertIn("Start 60-second review", html)
        ...
        self.assertIn("Start the 60-second review.", html)
        self.assertIn("Use follow-ups after the packet opens.", html)
        self.assertIn('class="composer-shell first-run-locked"', html)
        self.assertIn("Open the request, verdict, proof debt, and hash.", html)
        self.assertIn("See sponsor proof without approval or writes.", html)
        self.assertIn("Preview what downstream systems can trust.", html)
        self.assertIn("Follow-ups after packet load", html)
        self.assertIn("Open the IA Packet first; then ask packet-backed follow-ups.", html)
        ...
        self.assertIn('["1 · Packet", "Open the request, verdict, proof debt, and hash."]', js)
        ...
        self.assertIn("btnStartPortkeyPreview", js)
        self.assertIn('sendMessage("Can Portkey allow this spend?")', js)
    ...
    def test_design_partner_walkthrough_ui_is_reachable(self) -> None:
        ...
        self.assertIn('data-tab="start">Start</button>', html)
        ...
        self.assertIn("live_tavily: false", js)
